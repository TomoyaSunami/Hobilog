        ...
        <div className="heatmap-scroll">
          <div className="heatmap-year-grid">
            ...
            {["日", "月", "火", "水", "木", "金", "土"].map((label) => (
              <span className="h-[10px] text-center text-[10px] font-black leading-[10px] text-hobi-muted" key={label}>
                {label}
              </span>
            ))}
            {heatmapRows.map((row, rowIndex) => (
              <div className="contents" key={`week-${rowIndex}`}>
                <span className="h-[10px] text-[10px] font-black leading-[10px] text-hobi-muted">{row.label}</span>
